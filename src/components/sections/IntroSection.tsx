...
const IntroSection = () => {
  ...
  return (
    <section id="intro" className="section-container relative min-h-screen">
      {/* Decorative Elements */}
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        {/* Name */}
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-4 animate-fade-up-delay-1 text-white" style={{ fontFamily: "'SF Pro Display', -apple-system, BlinkMacSystemFont, sans-serif" }}>
          <span>Jascore</span>
          <span>.aep</span>
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12 animate-fade-up-delay-3">
          {["After Effects"].map(software => (
            <span key={software} className="px-4 py-2 rounded-full text-sm text-muted-foreground border border-border/50 bg-secondary/30">
              {software}
            </span>
          ))}
        </div>
